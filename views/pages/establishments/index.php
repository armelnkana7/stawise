            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <div class="d-flex">
                        ...
                        <button class="btn btn-sm btn-primary ms-3 px-4 py-3" data-bs-toggle="modal" data-bs-target="#modalEstablishmentCreate">Nouvel établissement</button>
                    ...
                    <!-- Establishment create modal -->
                    <div class="modal fade" id="modalEstablishmentCreate" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="<?= url('establishments'); ?>">
                                        <?= csrf_field(); ?>
                                        <div class="mb-3">

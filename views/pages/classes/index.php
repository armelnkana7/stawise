            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <div class="d-flex">
                        ...
                        <button class="btn btn-sm btn-primary ms-3 px-4 py-3" data-bs-toggle="modal" data-bs-target="#modalClassCreate">Nouvelle classe</button>
                    ...
                    <!-- Class create modal -->
                    <div class="modal fade" id="modalClassCreate" tabindex="-1" aria-hidden="true">
                                ...
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="<?php echo url('classes/subjects') . '?id=' . $c['id']; ?>"
                                                type="button" class="btn btn-sm text-primary">
                                                Voir
                                            </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a type="button" class="btn btn-sm text-success" data-bs-toggle="modal"
                                                data-bs-target="#modal-<?php echo $c['id']; ?>">
                                                Éditer
                                            </a>
                                        </div>

                                        <div class="menu-item px-3">
                                            <button type="button" class="btn btn-sm text-danger btn-open-delete-modal" data-action="<?php echo url('classes/delete'); ?>" data-id="<?php echo $c['id']; ?>" data-name="<?php echo htmlspecialchars($c['name']); ?>">Supprimer</button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="<?php echo url('classes/update'); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="section" class="form-control">
                                                                <option value="">Sélectionner</option>
                                                                <option value="1" <?php echo $c['section'] == 1 ? 'selected' : ''; ?>>Francophone</option>
                                                                <option value="2" <?php echo $c['section'] == 2 ? 'selected' : ''; ?>>Anglophone</option>
                                                            </select>
                                                        </div>
